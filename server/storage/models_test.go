...
func (test *ModelsRepositoryTest) TestCreate() {
    AssertCountChanged(test.db, "models", 1, func() {
...
func (test *ModelsRepositoryTest) TestCreateVersion() {
    AssertCountChanged(test.db, "model_versions", 1, func() {
        AssertCountChanged(test.db, "model_version_request_features", 1, func() {
...
func (test *ModelsRepositoryTest) TestDeleteVersionWhenVersionIsPrimary() {
    AssertCountChanged(test.db, "model_versions", 0, func() {

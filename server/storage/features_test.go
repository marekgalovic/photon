...
func (test *FeaturesRepositoryTest) SetupTest() {
    test.db = NewTestMysql()
    CleanupMysql(test.db)
...
func (test *FeaturesRepositoryTest) TestCreate() {
    AssertCountChanged(test.db, "feature_sets", 1, func() {
...
func (test *FeaturesRepositoryTest) TestDelete() {
    AssertCountChanged(test.db, "feature_sets", -1, func() {
        AssertCountChanged(test.db, "feature_set_schemas", -2, func() {
            AssertCountChanged(test.db, "feature_set_schema_fields", -2, func() {
...
func (test *FeaturesRepositoryTest) TestCreateSchema() {
    AssertCountChanged(test.db, "feature_set_schemas", 1, func() {
        AssertCountChanged(test.db, "feature_set_schema_fields", 2, func() {
